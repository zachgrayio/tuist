...
public enum Options_OptionMetadataTag: SwiftProtobuf.Enum {
  ...
  public init?(rawValue: Int) {
    ...
    case 6: self = .explicitInOutputPath
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  public var rawValue: Int {
    ...
    case .explicitInOutputPath: return 6
    case .UNRECOGNIZED(let i): return i
    }
  }
...
extension Options_OptionEffectTag: @unchecked Sendable {}
extension Options_OptionMetadataTag: @unchecked Sendable {}
...
extension Options_OptionMetadataTag: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .same(proto: "EXPLICIT_IN_OUTPUT_PATH"),
  ]
}
