...
public struct Google_Devtools_Build_V1_PublishLifecycleEventRequest {
  ...
  ///   parent event.
  public var checkPrecedingLifecycleEventsPresent: Bool {
    get {return _storage._checkPrecedingLifecycleEventsPresent}
    set {_uniqueStorage()._checkPrecedingLifecycleEventsPresent = newValue}
  }
...
public struct Google_Devtools_Build_V1_PublishBuildToolEventStreamRequest {
  ...
  public var checkPrecedingLifecycleEventsPresent: Bool = false
...
extension Google_Devtools_Build_V1_PublishLifecycleEventRequest: @unchecked Sendable {}
extension Google_Devtools_Build_V1_PublishLifecycleEventRequest.ServiceLevel: @unchecked Sendable {}
extension Google_Devtools_Build_V1_PublishBuildToolEventStreamResponse: @unchecked Sendable {}
extension Google_Devtools_Build_V1_OrderedBuildEvent: @unchecked Sendable {}
extension Google_Devtools_Build_V1_PublishBuildToolEventStreamRequest: @unchecked Sendable {}
...
extension Google_Devtools_Build_V1_PublishLifecycleEventRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "check_preceding_lifecycle_events_present"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _checkPrecedingLifecycleEventsPresent: Bool = false
    ...
    init(copying source: _StorageClass) {
      ...
      _checkPrecedingLifecycleEventsPresent = source._checkPrecedingLifecycleEventsPresent
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularEnumField(value: &_storage._serviceLevel) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._buildEvent) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._streamTimeout) }()
        case 4: try { try decoder.decodeRepeatedStringField(value: &_storage._notificationKeywords) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._projectID) }()
        case 7: try { try decoder.decodeSingularBoolField(value: &_storage._checkPrecedingLifecycleEventsPresent) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._buildEvent {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      try { if let v = _storage._streamTimeout {
      ...
      if _storage._checkPrecedingLifecycleEventsPresent != false {
        try visitor.visitSingularBoolField(value: _storage._checkPrecedingLifecycleEventsPresent, fieldNumber: 7)
      }
    }
  ...
  public static func ==(lhs: Google_Devtools_Build_V1_PublishLifecycleEventRequest, rhs: Google_Devtools_Build_V1_PublishLifecycleEventRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._checkPrecedingLifecycleEventsPresent != rhs_storage._checkPrecedingLifecycleEventsPresent {return false}
        return true
      }
...
extension Google_Devtools_Build_V1_PublishBuildToolEventStreamRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularBoolField(value: &self.checkPrecedingLifecycleEventsPresent) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._orderedBuildEvent {
    ...
    if self.checkPrecedingLifecycleEventsPresent != false {
      try visitor.visitSingularBoolField(value: self.checkPrecedingLifecycleEventsPresent, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Google_Devtools_Build_V1_PublishBuildToolEventStreamRequest, rhs: Google_Devtools_Build_V1_PublishBuildToolEventStreamRequest) -> Bool {
    ...
    if lhs.checkPrecedingLifecycleEventsPresent != rhs.checkPrecedingLifecycleEventsPresent {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
